...
public class SteamSocketOutputStream extends OutputStream {
    ...
    public void write(byte[] bArr, int i, int i2) throws IOException {
        ...
        if (i2 > 307200) {
            GameEngine.isInSpace("Steam spliting large packet to:" + this.b.e + " len:" + i2);
            int i3 = i2;
            do {
                int i4 = i3;
                if (i4 > 256000) {
        ...
        synchronized (this.b.a) {
            try {
                if (this.a) {
                    this.a = false;
                    GameEngine.isInSpace("First packet to:" + this.b.e);
                }
                if (!this.b.a.h.sendP2PPacket(this.b.e, byteBufferAllocateDirect, SteamNetworking.P2PSend.Reliable, 0)) {
                    GameEngine.isInSpace("steam sendP2PPacket failed (size: " + i2 + " to:" + this.b.e + ")");
                }
