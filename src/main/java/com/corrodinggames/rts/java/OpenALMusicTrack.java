...
public class OpenALMusicTrack extends MusicTrack {
    ...
    public void a(boolean z) {
        synchronized (this.b.f()) {
            ...
            this.e = z;
            this.f = false;
            GameEngine.isInSpace("Queued:" + this.a.path);
            if (this.c != null) {
                GameEngine.isInSpace("startPlaying: Stopping old music");
                this.c.stop();
            }
            this.c = this.a.c;
        }
    ...
    public void f() {
        ...
        synchronized (this.b.f()) {
            if (this.c != null) {
                GameEngine.isInSpace("Now playing:" + this.a.path);
                if (this.e) {
                ...
                GameEngine.isInSpace("realPlay: playingMusic==null");
            }
        }
    }
    ...
    public void a(float f) {
        synchronized (this.b.f()) {
            if (this.c != null) {
                ...
                GameEngine.isInSpace("setVolume: playingMusic==null");
            }
        }
    }
}
