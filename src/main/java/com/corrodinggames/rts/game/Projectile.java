...
public class Projectile extends PositionedObject {
    ...
    public void update(float f2) {
        ...
        if (projectileTemplate.R != 0.0f || projectileTemplate.S != 0.0f) {
            ...
            if (this.l != null) {
                f9 += this.l.speed * projectileTemplate.S;
            }
            this.K = Utility.fastSin(((360.0f * this.I) + (this.J * 1.0f)) % 360.0f) * f9;
            this.L = Utility.fastSin(((360.0f * this.I) + (this.J * 1.5f)) % 360.0f) * f9;
        }
        if (this.E && this.l != null) {
            this.K = Utility.fastSin((this.J * 1.0f) % 360.0f) * this.l.speed * 0.4f;
            this.L = Utility.fastSin((this.J * 1.5f) % 360.0f) * this.l.speed * 0.4f;
        ...
        if (!this.bn) {
            ...
            if (this.as) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (baseUnit2.posX + f35 > this.posX && baseUnit2.posX - f35 < this.posX && baseUnit2.posY + f35 > this.posY && baseUnit2.posY - f35 < this.posY && baseUnit2.isAttacking && false == baseUnit2.i() && baseUnit2.unitTransportTarget == null) {
                        float fDistanceSq2 = Utility.distanceSq(this.posX, this.posY, baseUnit2.posX, baseUnit2.posY);
                        float f36 = this.aA + baseUnit2.speed;
