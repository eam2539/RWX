            ...
            while (true) {
                ...
                if (baseUnit2 != null) {
                    ...
                    if (!(baseUnit2 instanceof OrderableUnit)) {
                        GameEngine.isInSpace("Failed to deattach unit:" + baseUnit2.r().getUnitTypeDescriptionShort() + " is not an OrderableUnit");
                    } else {
        ...
        if (this.addNewUnits != null) {
            ...
            for (BaseUnit baseUnit4 : fastArrayList) {
                ...
                if (!(baseUnit4 instanceof OrderableUnit)) {
                    GameEngine.isInSpace("Failed to attach unit:" + baseUnit4.r().getUnitTypeDescriptionShort() + " is not an OrderableUnit");
                } else {
