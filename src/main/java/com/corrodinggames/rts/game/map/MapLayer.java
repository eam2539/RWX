        ...
        if (mapTile.isResourcePool) {
            ...
            for (Point point : this.tileMap.unitObjects) {
                if (point.worldX == i && point.worldY == i2) {
                    GameEngine.isInSpace("resPools point:" + i + ", " + i2 + " already exists");
                    z2 = true;
                }
            }
            if (!z2) {
                            ...
                            if (b2 >= 5) {
                                ...
                                if (bClampWorldX != 0) {
                                    ...
                                    if (texture != null) {
                                        ...
                                        GameEngine.isInSpace("SmoothFog, missing: " + ((int) bClampWorldX));
                            ...
                            if (b2 != 10) {
                                ...
                                if (bClampWorldX2 != 0) {
                                    ...
                                    if (texture != null) {
                                        ...
                                        GameEngine.isInSpace("SmoothFog, missing: " + ((int) bClampWorldX2));
