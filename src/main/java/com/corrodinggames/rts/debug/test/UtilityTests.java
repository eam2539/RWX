...
public class UtilityTests extends Test {
    ...
    public void runAllTests() {
        ...
        for (int i = 1; i < 5; i++) {
            ...
            GameEngine.isInSpace("sum:" + iSqrt);
            GameEngine.isInSpace("fastSquareRootInt took:" + PerformanceProfiler.a(PerformanceProfiler.a(jA)));
            ...
            GameEngine.isInSpace("sum:" + iSortRect);
            GameEngine.isInSpace("squareRoot took:" + PerformanceProfiler.a(PerformanceProfiler.a(jA2)));
        }
        GameEngine.isInSpace("CommonUtils.fastSplit");
        ...
        GameEngine.isInSpace("VariableReplacement");
        ...
        try {
            ...
            try {
                ...
                GameEngine.isInSpace("PassthroughZipReader");
                ...
                assertKeyValueEquals("(A,A)=('1,,1')", "BB=((2,2))");
                GameEngine.isInSpace("splitWithEscaping");
                ...
                GameEngine.isInSpace("FileLoaderBackend");
                ...
                GameEngine.isInSpace("FileLoaderBackend - merged");
                ...
                GameEngine.isInSpace("FileLoaderBackend - android fake");
                ...
                try {
                    ...
                    if (1 != 0) {
                        GameEngine.isInSpace("FileLoaderBackend - real file tests");
                        ...
                        try {
                            try {
                                ...
                                GameEngine.isInSpace("FileLoaderBackend - clean up");
                                for (String str2 : file.list()) {
                                    new File(file.getPath(), str2).delete();
                                }
                                file.delete();
                                GameEngine.isInSpace("isSameOrHigherVersion..");
