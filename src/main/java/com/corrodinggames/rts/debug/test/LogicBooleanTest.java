...
public class LogicBooleanTest extends Test {
    ...
    public void runTests() {
        GameEngine.isInSpace("Logic boolean tests");
        ...
        GameEngine.isInSpace("string: " + getLogicBooleanValue(orderableUnitA2, parseLogicBoolean("str(memory.numArrayA)")));
        ...
        GameEngine.isInSpace("=== logic boolean tests == (runs:50)");
        ...
        for (int i = 0; i < 50; i++) {
            ...
            if (orderableUnitA2 == PlayerTeam.TEAM_ALL.teamCommandCenter) {
                GameEngine.isInSpace("skipping for placeholderTeamUnit");
            } else {
        ...
        GameEngine.isInSpace("=== logic boolean memory tests ==");
        ...
        GameEngine.isInSpace(orderableUnitA2.unitVariables.debugMemory(false, true));
    ...
    public void assertLogicBooleanHolder(OrderableUnit orderableUnit, LogicBoolean logicBoolean, BaseUnit baseUnit) {
        ...
        if (unit != baseUnit) {
            GameEngine.isInSpace("class: " + logicBoolean.getClass().getName());
