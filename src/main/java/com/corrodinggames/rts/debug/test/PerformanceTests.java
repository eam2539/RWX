...
public class PerformanceTests extends Test {
    ...
    public void runPerformanceTests() {
        GameEngine.isInSpace("Misc Performance test");
        int i = 0;
        GameEngine.isInSpace("=== applyDigitGroupingStyle tests (runs:5)");
        ...
        int i4 = 0;
        GameEngine.isInSpace("=== applyDigitGroupingStyle_systemLibraryVersion tests (runs:5)");
        ...
        GameEngine.isInSpace("Took: " + dA2);
        int i7 = 0;
        GameEngine.isInSpace("=== isLineClear tests (runs:3)");
        ...
        GameEngine.isInSpace("Took: " + dA3);
        int i10 = 0;
        GameEngine.isInSpace("=== maths tests == (runs:3)");
        ...
        GameEngine.isInSpace("=== CustomTagList tests == (runs:5)");
        ...
        for (int i18 = 0; i18 < 2; i18++) {
            ...
            for (int i22 = 0; i22 < 5; i22++) {
                ...
                this.assertionCounter += 0;
                GameEngine.isInSpace("Took: " + dA7);
            }
        }
        int i25 = 0;
        GameEngine.isInSpace("=== [Virtual method]/if tests == (runs:5)");
        ...
        for (int i30 = 0; i30 < 7; i30++) {
            ...
            GameEngine.isInSpace("Took: " + dA9);
        }
        int i33 = 0;
        GameEngine.isInSpace("=== comparison tests 1 == (runs:10)");
        for (int i34 = 0; i34 < 14; i34++) {
            ...
            GameEngine.isInSpace("Took: " + dA10);
        }
        int i40 = 0;
        GameEngine.isInSpace("=== comparison tests 2 == (runs:10)");
        for (int i41 = 0; i41 < 14; i41++) {
            ...
            GameEngine.isInSpace("Took: " + dA11);
        }
        int i47 = 0;
        GameEngine.isInSpace("=== [divide]/multiply float tests == (runs:5)");
        for (int i48 = 0; i48 < 5; i48++) {
            ...
            GameEngine.isInSpace("Took: " + dA12);
        }
        int i52 = 0;
        GameEngine.isInSpace("=== divide/[multiply] float tests == (runs:5)");
        for (int i53 = 0; i53 < 5; i53++) {
            ...
            GameEngine.isInSpace("Took: " + dA13);
        }
        int i57 = 0;
        GameEngine.isInSpace("=== [divide]/multiply int tests == (runs:5)");
        for (int i58 = 0; i58 < 5; i58++) {
            ...
            GameEngine.isInSpace("Took: " + dA14);
        }
        int i62 = 0;
        GameEngine.isInSpace("=== [float cast and divide]/multiply int tests == (runs:5)");
        for (int i63 = 0; i63 < 5; i63++) {
            ...
            GameEngine.isInSpace("Took: " + dA15);
        }
        int i67 = 0;
        GameEngine.isInSpace("=== [mixed float and divide]/multiply int tests == (runs:5)");
        for (int i68 = 0; i68 < 5; i68++) {
            ...
            GameEngine.isInSpace("Took: " + dA16);
        }
        int i72 = 0;
        GameEngine.isInSpace("=== divide/[multiply] int tests == (runs:5)");
        for (int i73 = 0; i73 < 5; i73++) {
            ...
            GameEngine.isInSpace("Took: " + dA17);
        }
    }
}
