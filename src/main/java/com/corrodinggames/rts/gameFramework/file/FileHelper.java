    ...
    public static void initialize() {
        ...
        if (GameEngine.isDesktop()) {
            if (Build.VERSION.SDK_INT < 19) {
                ...
                GameEngine.isInSpace("FileLoader: SDK too old, not changing FileLoader");
                return;
            }
            int i = GameEngine.getInstance().settingsEngine.storageType;
            GameEngine.isInSpace("FileLoader: storageBehaviour:" + i);
            FileLoader fileLoaderCreateFileLoader = createFileLoader(i);
            GameEngine.isInSpace("Using file loader: " + fileLoaderCreateFileLoader.d());
    ...
    public static FileLoader createFileLoader(int i) {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            ...
            if (!fileAccessFlags.useOverriddenExternalPath) {
                ...
                GameEngine.isInSpace("FileLoader using overriddenExternalPath:" + overriddenExternalPath);
