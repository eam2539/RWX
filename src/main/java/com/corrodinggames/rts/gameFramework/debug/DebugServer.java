...
public class DebugServer implements Runnable {
    ...
    public static void a() {
        ...
        GameEngine.isInSpace("-----");
        GameEngine.isInSpace("----- Debug Active ----");
        GameEngine.isInSpace("-----");
        GameEngine.isInSpace("-----");
    ...
    public void a(int i, String str) {
        try {
            ...
            GameEngine.isInSpace("----- createDebugSocket ----");
            GameEngine.isInSpace("port: " + i);
            GameEngine.isInSpace("password: " + str);
            GameEngine.isInSpace("------------------");
            GameEngine.isInSpace(VariableScope.nullOrMissingString);
            if (i != -1) {
        ...
        while (this.i) {
            try {
                ...
                try {
                    ...
                    GameEngine.isInSpace("Got IOException on debug connection");
                    e2.printStackTrace();
                    throw new RuntimeException(e2);
                }
