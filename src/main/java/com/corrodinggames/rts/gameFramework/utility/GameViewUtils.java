...
public final class GameViewUtils {
    ...
    public static boolean a(float f2, float f3) {
        TileMap tileMap = GameEngine.getInstance().tileMap;
        if (tileMap == null) {
            GameEngine.isInSpace("isInMap called without map loaded");
            return false;
        }
    ...
    public static boolean b(float f2, float f3) {
        ...
        if (tileMap == null) {
            GameEngine.isInSpace("isOverClift called without map loaded");
            return false;
        }
    ...
    public static boolean c(float f2, float f3) {
        ...
        TileMap tileMap = gameEngine.tileMap;
        if (tileMap == null) {
            GameEngine.isInSpace("isOverWater called without map loaded");
            return false;
        }
    ...
    public static boolean d(float f2, float f3) {
        ...
        TileMap tileMap = gameEngine.tileMap;
        if (tileMap == null) {
            GameEngine.isInSpace("isOverLiquid called without map loaded");
            return false;
        }
