        ...
        for (int var10 = 0; var10 < var9; var10++) {
            ...
            if (var12 != 0) {
                ...
                if (var4[var3] == var13) {
                    ...
                    GameEngine.isInSpace("Bad bracket order: '" + string1 + "' at index:" + var10 + " got " + var13 + " type expected: " + var4[var3]);
                }
            }
            ...
            if (!(z2 || z3)) {
                ...
                if (c != 0) {
                    ...
                    if (cArr[i2] == c2) {
                        ...
                        GameEngine.isInSpace("Bad bracket order: '" + str + "' at index:" + i3 + " got " + c2 + " type expected: " + cArr[i2]);
                    }
                }
