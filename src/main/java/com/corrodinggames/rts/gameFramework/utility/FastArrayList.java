...
/* JADX INFO: renamed from: com.corrodinggames.rts.gameFramework.utility.m */
/* JADX INFO: loaded from: game-lib.jar:com/corrodinggames/rts/gameFramework/utility/m.class */
public final class FastArrayList<T> extends AbstractList<T> implements Serializable, Cloneable, RandomAccess {
    ...
    static /* synthetic */ int e(FastArrayList fastArrayList) {
        return fastArrayList.modCount;
    }

    static /* synthetic */ int d(FastArrayList fastArrayList) {
        int i = fastArrayList.modCount + 1;
        fastArrayList.modCount = i;
        return i;
    }
    ...
    public FastArrayList(int i) {
        ...
        this.elements = i == 0 ? EmptyArrays.EMPTY_OBJECT : new Object[i];
    }

    public FastArrayList() {
        this.elements = EmptyArrays.EMPTY_OBJECT;
    }
    ...
    public Object clone() {
        try {
            ...
            fastArrayList.elements = (Object[]) this.elements.clone();
    ...
    public Iterator iterator() {
        return new FastArrayListIterator(this);
    }
