...
public final class PathCostMap {
    ...
    public strictfp void a(OrderableUnit var_1_54) {
        if (var_1_54 != null) {
            ...
            if (this.l > 50) {
                if (!this.m) {
                    GameEngine.isInSpace("buildAndReplaceClearanceCost being skipped");
                }
                this.m = true;
                return;
            }
        ...
        if (var_1_54 == null) {
            ...
            if (double1 > 30.0) {
                GameEngine.isInSpace("buildAndReplaceClearanceCostNew took:" + PerformanceProfiler.a(double1) + " for:" + this.a);
            }
        }
    }
    ...
    strictfp void b(OrderableUnit var_1_21) {
        ...
        if (var_1_21 == null) {
            GameEngine.isInSpace("buildAndReplaceClearanceCost took:" + PerformanceProfiler.a(PerformanceProfiler.a(a)) + " for:" + this.a);
        }
    }
    ...
    public strictfp void e() {
        ...
        for (int i = 0; i < BaseUnit.bE.size(); ++i) {
            ...
            if (baseUnit.isAttacking && !baseUnit.bI() && !baseUnit.isRepairing && !(baseUnit instanceof Tree) && !baseUnit.isDestroyed && !baseUnit.i() && baseUnit.unitTransportTarget == null && !baseUnit.Q()) {
                int n = 2;
                ...
                final float n2 = baseUnit.speed + 5.0f;
                final float n3 = baseUnit.speed + 10.0f;
                if (n3 < 10.0f) {
                    n = 0;
                }
                else if (n3 < 20.0f) {
