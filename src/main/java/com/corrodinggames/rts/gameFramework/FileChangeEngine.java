...
public class FileChangeEngine {
    ...
    public static synchronized void a(boolean z) {
        ...
        if (z) {
            if (b != null) {
                GameEngine.isInSpace("FileChangeEngine: Already running");
                return;
            }
            GameEngine.isInSpace("FileChangeEngine: Starting");
    ...
    public static void b() {
        ...
        while (enumerationKeys.hasMoreElements()) {
            ...
            Long l = (Long) a.get(str);
            if (l == null) {
                GameEngine.isInSpace("FileChangeEngine: old lastModified null for " + str);
            } else if (l.longValue() != jA) {
                GameEngine.isInSpace("FileChangeEngine: Detected change to:" + str + " now " + jA);
            }
