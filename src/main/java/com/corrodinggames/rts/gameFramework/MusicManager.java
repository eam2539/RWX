...
public class MusicManager {
    ...
    public boolean updateMusic(float f) {
        try {
            ...
            this.crashed = true;
            GameEngine.isInSpace("Stopping music");
            try {
                pauseMusic();
                return false;
            } catch (Exception e2) {
    ...
    public void updateMusicInner(float f) {
        ...
        if (this.noLoop) {
            ...
            if (this.trackTimeout > 3600.0f) {
                GameEngine.isInSpace("Next music track, timer:" + this.trackTimeout);
                z = true;
                this.trackTimeout = 0.0f;
            }
        }
        ...
        if (z || this.nextTrackRequested) {
            ...
            if (this.nextTrackRequested) {
                GameEngine.isInSpace("Next music track requested");
            ...
            if (str != null) {
                ...
                if (randomMusicPath == null) {
                    GameEngine.isInSpace("Failed to find requested music: " + str);
                }
            }
            ...
            if (randomMusicPath == null && lastSelectedUnitModInfo2 != null && lastSelectedUnitModInfo2.hasImages < 10 && lastSelectedUnitModInfo2.playMusicExclusively) {
                ...
                if (unitBlueprints.size() > 0) {
                    ...
                    GameEngine.isInSpace("Playing music from mod:" + lastSelectedUnitModInfo2.getDisplayTitle() + " - '" + randomMusicPath + "'");
                }
            }
            if (randomMusicPath == null) {
                if (this.firstPlay) {
            ...
            if (!randomMusicPath.equals(this.currentTrackPath)) {
                ...
                GameEngine.isInSpace("Same music found");
            }
        }
