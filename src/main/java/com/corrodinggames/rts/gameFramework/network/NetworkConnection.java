...
public class NetworkConnection {
    ...
    public void logInfo(String str) {
        GameEngine.isInSpace(formatLogPrefix(str));
    }
    ...
    public void finalize() {
        try {
            ...
            GameEngine.isInSpace("Connection::finalize called on unclosed socket (index:" + this.connectionId + ")");
            if (this.socket.getInetAddress() == null) {
                GameEngine.isInSpace("Skipping possible steam socket");
            }
            try {
                this.socket.close();
            } catch (IOException e) {
