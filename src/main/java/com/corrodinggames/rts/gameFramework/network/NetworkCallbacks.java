...
public class NetworkCallbacks {
    ...
    public String a(NetworkConnection networkConnection, String str, int i, int i2, String str2, GameTeam gameTeam) {
        GameEngine.isInSpace("new player Joining packageName:" + str2 + ", appVersion:" + i2 + ", playerName:" + str + " ip:" + networkConnection.getDisplayIpAddress() + " id:" + networkConnection.connectionId);
        return null;
    }
    ...
    public void onStartGameEvent() {
        GameEngine.isInSpace("NetworkCallbacks:startGameEvent()");
    }
