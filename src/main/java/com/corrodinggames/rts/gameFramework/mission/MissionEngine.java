...
public class MissionEngine extends Serializable {
    ...
    public void a(final boolean boolean1) throws MapLoadException {
        ...
        if (this.k) {
            ...
            if (this.l) {
                GameEngine.isInSpace("Classic survial waves selected");
            }
            this.f();
            this.p = false;
            ...
            if (s != null) {
                ...
                for (int length = split.length, i = 0; i < length; ++i) {
                    ...
                    if (d == null) {
                        ...
                        GameEngine.isInSpace("Possible IDs:");
                        for (final MapTrigger mapTrigger : this.J) {
                            if (mapTrigger.b != null) {
                                GameEngine.isInSpace(mapTrigger.b);
                            }
                        }
        ...
        GameEngine.isInSpace("Found " + this.J.size() + " map triggers");
        ...
        for (MapTrigger mapTrigger : this.J) {
            if (mapTrigger.g == TriggerType.objective) {
                ...
                if (!z) {
                    ...
                    GameEngine.isInSpace("Found objective: " + triggerWrapper.a());
                }
            }
        }
    }
    ...
    public void g(String str) throws MapLoadException {
        GameEngine.isInSpace("Loading survival waves");
        this.N = true;
        int i = 0;
        int i2 = 0;
        for (String str2 : str.split("\n")) {
            ...
            if (waveVar.a(str2)) {
                ...
                i = waveVar.e;
                GameEngine.isInSpace("Adding wave " + i2 + " at " + waveVar.e);
                this.O.add(waveVar);
            }
        }
    }
    ...
    public void h(String str) {
        GameEngine.isInSpace("Map Script: " + str);
    }
