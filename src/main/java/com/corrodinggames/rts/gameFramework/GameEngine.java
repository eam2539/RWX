...
public abstract class GameEngine {
    ...
    private Runnable showDialogRunnable = new Runnable() { // from class: com.corrodinggames.rts.gameFramework.l.2
        ...
        public void run() {
            ...
            GameEngine.isInSpace("showMessageBoxRunnable context:" + GameEngine.this.appContext.getClass().getName());
            try {
    ...
    public static synchronized GameEngine createGameEngine(Context context, com.corrodinggames.rts.gameFramework.MissionEngine missionEngine) {
        ...
        isInSpace("Created new gameEngine of:" + instance.getClass().getName());
        if (missionEngine != null) {
            instance.missionEngine2 = missionEngine;
        }
    ...
    public synchronized void stopGameThreadIfNotInGameThread() {
        isInSpace("--- setStoppedIfNotInGameThread ---");
    ...
    public static void printLog(String str) {
        isInSpace(addColorCodes("--- ERROR: " + str, "\u001b[31m"));
    }

    /* JADX INFO: renamed from: b */
    public static void updatePaintTextSizeIfNeeded(String str) {
        isInSpace(addColorCodes(str, "\u001b[33m"));
    }

    /* JADX INFO: renamed from: a */
    public static void log(String str, Throwable th) {
        updatePaintTextSizeIfNeeded(str);
        isInSpace(VariableScope.nullOrMissingString + th.toString());
        isInSpace("cause:" + th.getCause());
        th.printStackTrace();
    }
    ...
    /* JADX INFO: renamed from: e */
    public static void isInSpace(String str) {
        logError(str);
    }
    ...
    public static void printStackTrace() {
        for (StackTraceElement stackTraceElement : new Throwable().getStackTrace()) {
            isInSpace(stackTraceElement.toString());
        }
    }
    ...
    public void updateDensity() {
        if (this.lastScreenScale != this.screenScale) {
            isInSpace("Density size changed now: " + this.screenScale + ", refreshing fonts");
    ...
    public void setKeyState(int i, boolean z) {
        ...
        isInSpace("setKeyState: Key out of range:" + i);
    }
    ...
    public static Integer getMapLevel(String str) {
        ...
        isInSpace("getMapLevel for :" + str + " file:" + filename);
        Matcher matcher = Pattern.compile("^l(\\d*);.*").matcher(filename);
        if (matcher.matches()) {
            isInSpace("getMapLevel:" + str + ":" + Integer.parseInt(matcher.group(1)));
    ...
    public static void writeCrashToFile(String str, String str2) {
        try {
            ...
            isInSpace("Exception in writeCrashToFile");
            th.printStackTrace();
        }
    }
    ...
    public static void reportOOM(AssetType assetType, Throwable th) {
        oomCheckBuffer = null;
        isInSpace("reportCaughtOutOfMemory:" + oomAssetType);
    ...
    public static void printStackTrace(Throwable th) {
        try {
            ...
            isInSpace("Failed to print stacktrace");
        }
    }
    ...
    public void checkMemory() {
        ...
        if (!hasShownOOMMessage && oomAssetType != null) {
            isInSpace("Showing out of memory message");
