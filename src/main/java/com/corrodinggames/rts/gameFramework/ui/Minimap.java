...
public class Minimap {
    ...
    public void createImageBuffers() {
        GameEngine gameEngine = GameEngine.getInstance();
        updateDimensions();
        GameEngine.isInSpace("Creating minimap image buffers..");
        if (this.backgroundTexture == null) {
    ...
    public void setup() {
        ...
        GameEngine.isInSpace("--setting up minimap--");
        GameEngine gameEngine = GameEngine.getInstance();
        updateDimensions();
        ...
        drawFog(0.0f, 1.0f);
        this.isSetup = true;
        GameEngine.isInSpace("Minimap map render took:" + PerformanceProfiler.a(PerformanceProfiler.a(jA)));
    }
