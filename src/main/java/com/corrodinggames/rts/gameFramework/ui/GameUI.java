...
import com.corrodinggames.rts.game.units.actions.AttackMoveAction;
import com.corrodinggames.rts.game.units.actions.GuardUnitAction;
import com.corrodinggames.rts.game.units.actions.MapPingToolAction;
import com.corrodinggames.rts.game.units.actions.PatrolAction;
import com.corrodinggames.rts.game.units.actions.PingMapAction;
import com.corrodinggames.rts.game.units.actions.TeamChatToolAction;
...
import com.corrodinggames.rts.game.units.custom.resources.CreditsResource;
...
import com.corrodinggames.rts.gameFramework.ui.widgets.NinePatchStyle;
import com.corrodinggames.rts.gameFramework.ui.widgets.UIElement;
import com.corrodinggames.rts.gameFramework.ui.widgets.UIEvent;
import com.corrodinggames.rts.gameFramework.ui.widgets.UIState;
...
public final class GameUI extends Serializable {
    ...
    public void initializeUIResources(Context context) {
        ...
        this.unitSelectionPaint.b(Color.a(100, 0, 0, 0));
        ...
        GameEngine.isInSpace("smallTextPaint size: " + this.buildingPreviewPaint.k());
        ...
        this.minimapViewportPaint.b(Color.a(120, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_TERRESTRIAL_ANALOG, 167, 49));
    ...
    public void updateInput(float f) throws ConfigParseException {
        ...
        if (gameEngine.settingsEngine.keyboardSupport) {
            ...
            if (inputController.t.a() && gameEngine.isNetworkConnected()) {
                GameEngine.isInSpace("showing send chat");
                this.interfaceRenderer.a(13);
            }
            if (inputController.u.a() && gameEngine.isNetworkConnected()) {
                GameEngine.isInSpace("showing send team chat");
            ...
            if (gameEngine.isGameStarted && inputController.ab.a()) {
                ...
                GameEngine.isInSpace("debugTempMode now: " + gameEngine.isNetworkGameActive);
            ...
            if (gameEngine.loadLevelNetwork() || gameEngine.replayEngine.j()) {
                if (gameEngine.isGameStarted) {
                    ...
                    if (inputController.X.a()) {
                        GameEngine.isInSpace("Adding test popup");
        ...
        if (gameEngine.isGameStarted) {
            ...
            if (this.editorOrBuilder == null) {
                GameEngine.isInSpace("Creating new debug editor");
    ...
    /* JADX INFO: renamed from: c */
    public void handleTouchGestures(float f) {
        float f2;
        float f3;
        GameEngine gameEngine = GameEngine.getInstance();
    ...
    public void a(OrderableUnit orderableUnit, float f, float f2, float f3, float f4, boolean z, ArrayList arrayList, BaseUnit baseUnit) {
        ...
        if (!(baseUnitFindCollisionSize instanceof OrderableUnit)) {
            GameEngine.isInSpace("buildingBlockoutUnit not OrderableUnit is: " + baseUnitFindCollisionSize.getClass().getName());
        } else {
        ...
        if (am != null && active != -1 && b2) {
            ...
            if (!b3 || active > 0) {
                ...
                if (timerValue != 0.0f) {
                    ...
                    int integer1;
                    if (timerValue > 0.0f) {
                        integer1 = Color.a(110, 30, 240, 30);
                    }
                    else {
