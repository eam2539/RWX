...
public final class Locale {
    ...
    static ResourceBundle loadBundle(String str, java.util.Locale locale) {
        ...
        if (java.util.Locale.ROOT.equals(locale)) {
            GameEngine.isInSpace("Locale: Using " + str2 + " as locale");
        ...
        if (propertyResourceBundleLoadBundleFromPath2 == null) {
            GameEngine.isInSpace("Locale: No locale for " + str3 + " checking locale without variant ");
            str3 = buildLocaleString(str, locale, true, false) + ".properties";
            propertyResourceBundleLoadBundleFromPath2 = loadBundleFromPath(str3);
            if (propertyResourceBundleLoadBundleFromPath2 == null) {
                GameEngine.isInSpace("Locale: No locale for " + str3 + " checking locale without variant or country");
                str3 = buildLocaleString(str, locale, false, false) + ".properties";
                propertyResourceBundleLoadBundleFromPath2 = loadBundleFromPath(str3);
                if (propertyResourceBundleLoadBundleFromPath2 == null) {
                    GameEngine.isInSpace("Locale: No locale for " + str3 + " using base locale");
                    return propertyResourceBundleLoadBundleFromPath;
                }
            }
        }
        GameEngine.isInSpace("Locale: Using " + str3 + " as locale");
    ...
    public static synchronized void reload() {
        ...
        if (resourceBundle != null && forceEnglish == z) {
            GameEngine.isInSpace("Locale.reload: skipping reload");
        }
        if (Build.VERSION.SDK_INT >= 9) {
            ResourceBundle.clearCache();
        }
        if (z) {
            GameEngine.isInSpace("Locale: forceEnglish");
            ...
            GameEngine.isInSpace("Locale: default targetLocale:" + locale);
            if (locale != null) {
                GameEngine.isInSpace("Locale: default targetLocale ISO3:" + locale.getISO3Language());
            }
    ...
    public static final String translateMapName(String str) {
        ...
        if (hasString(str2)) {
            ...
            GameEngine.isInSpace("translated:" + strReplace);
            if (strReplace != null) {
    ...
    public static String convertInlineBlocks(String str) {
        ...
        while (matcher.find()) {
            ...
            if (formattedString == null) {
                GameEngine.isInSpace("convertInlineBlocks: No key:" + strGroup);
