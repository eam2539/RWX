...
public final class PathEngine {
    ...
    public synchronized void a(TileMap tileMap, boolean z) {
        d();
        GameEngine.isInSpace("PathEngine: Setting up map costs");
        boolean z2 = false;
        if (z && this.q != null && this.q == tileMap && this.s == tileMap.groundLayer.widthTiles && this.t == tileMap.groundLayer.heightTiles) {
            if (this.r == PathCostMap.a(tileMap)) {
                GameEngine.isInSpace("PathEngine: Keeping existing map costs");
                z2 = true;
            } else {
                GameEngine.isInSpace("PathEngine: Error: Map checksum does not match!!!");
            }
        }
        if (z2) {
        }
        ...
        this.o.a(tileMap);
        GameEngine.isInSpace("PathEngine: Ready");
    }
