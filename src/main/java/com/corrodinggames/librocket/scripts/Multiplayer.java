...
public class Multiplayer extends ScriptContext {
    ...
    void updateMapDropdown(Element element, String str, String str2) {
        ...
        GameEngine.isInSpace("mapList:" + str6);
        if (iIntValue != 2) {
        }
    ...
    public void refreshUI() {
        ...
        if (activeElementById == null) {
            GameEngine.isInSpace("refreshUI: infoTextElement==null");
            return;
        }
        ElementDocument activeDocument = this.libRocket.getActiveDocument();
        ...
        if ((gameEngine.networkEngine.aw() || (gameEngine.networkEngine.localPlayerTeam == playerTeamK && !gameEngine.networkEngine.roomSettings.teamLock)) && (elementDocumentCreateAndShowPopup = this.root.createAndShowPopup("battleroom_player.rml", playerTeamK, playerTeamK.teamName)) != null) {
            ...
            if (!GameEngine.isPlatformName("s3")) {
                if (playerTeamK.teamAIControlOverride == null) {
                    ...
                    GameEngine.isInSpace("playerColor: " + playerTeamK.teamAIControlOverride);
                    elementById6.setValue(VariableScope.nullOrMissingString + playerTeamK.teamAIControlOverride);
                    return;
                }
            }
            GameEngine.isInSpace("s3");
        }
    }
    ...
    public void teamsSet_apply() {
        ...
        GameEngine.isInSpace("playerConfig_kick");
    ...
    public void playerConfig_apply() {
        ...
        if (playerTeamK.isTeamSpectator) {
            ...
            if (playerTeamK.teamAIDifficultyOverride != numValueOf3) {
                if (gameEngine.networkEngine.isServer) {
                    ...
                    GameEngine.isInSpace("aiDifficultyOverride: not server or proxy controller");
                }
            }
        }
        int iIntValue4 = elementById4.getValueAsInt(-99).intValue();
        GameEngine.isInSpace("startingUnits now: " + iIntValue4);
        if (iIntValue4 == -99) {
            numValueOf = null;
        } else {
        ...
        if (playerTeamK.teamAIBehaviourOverride != numValueOf) {
            if (gameEngine.networkEngine.isServer) {
                ...
                GameEngine.isInSpace("startingUnitOverride: not server or proxy controller");
            }
        }
        int iIntValue5 = elementById5.getValueAsInt(-99).intValue();
        GameEngine.isInSpace("playerColor now: " + iIntValue5);
        if (iIntValue5 == -99) {
            numValueOf2 = null;
        } else {
        ...
        if (playerTeamK.teamAIControlOverride != numValueOf2) {
            if (gameEngine.networkEngine.isServer) {
                ...
                GameEngine.isInSpace("colorOverride: not server or proxy controller");
            }
        }
        if (z3) {
            if (gameEngine.networkEngine.isServer) {
    ...
    public void surrender() {
        GameEngine.isInSpace("Surrender requested");
    ...
    public void sendReturnToBattleroomEvent() {
        GameEngine.isInSpace("mp.sendReturnToBattleroomEvent()");
        GameEngine gameEngine = GameEngine.getInstance();
    ...
    public void loadUsername() {
        GameEngine.isInSpace("mp.loadUsername()");
        ...
        GameEngine.isInSpace("steamName:" + strC);
    ...
    public void getUsernameFromInterface() {
        ...
        GameEngine.isInSpace("set username:" + strTrim);
    ...
    public void gameOptionsGetOrPush(boolean z) {
        ...
        if (!z) {
            if (gameEngine.networkEngine.roomSettings.gameModeType == null) {
                GameEngine.isInSpace("gameOptionsGetOrPush: game.network.setup.currentType==null");
            } else {
            ...
            if (this.useMapDropdown) {
                ...
                GameEngine.isInSpace("new currentMapSelection=" + gameEngine.networkEngine.roomSettings.mapPath);
        ...
        if (gameRoomSettingsE != null) {
            ...
            if (this.useMapDropdown) {
                ...
                if (value == null) {
                    GameEngine.isInSpace("gameOptionsGetOrPush: mapDropdownSelected==null");
                    value = "<No Map>";
                }
            }
    ...
    public void closeBattleroomIfOpen() {
        ...
        if (this.libRocket.getActiveElementById("battleroomPage") == null) {
            GameEngine.isInSpace("closeBattleroomIfOpen: battleroomPage==null");
        } else {
    ...
    public void askPassword() {
        GameEngine.isInSpace("mp.askPassword()");
        GameEngine.getInstance();
    ...
    public void askPasswordEntered(String str) {
        GameEngine.isInSpace("mp.askPasswordEntered()");
        GameEngine gameEngine = GameEngine.getInstance();
