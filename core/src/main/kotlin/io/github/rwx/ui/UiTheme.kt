...
object UiTheme {
    ...
    object Layout {
        ...
        val snackbarWidth: Dp = Dp(760f)
        val snackbarMinWidth: Dp = Dp(300f)
        val snackbarMaxWidth: Dp = Dp(940f)
        val snackbarMinHeight: Dp = Dp(56f)
        val snackbarActionButtonWidth: Dp = Dp(176f)
    ...
    object Fonts {
        const val CJK_MSDF_FONT_PATH: String = "font/rwx-cjk"
        const val TITLE_MSDF_FONT_PATH: String = "font/rwx-title"
