...
public class MathTest extends Test {
    ...
    public void runTests() {
        ...
        GameEngine.log("diff sin(0):  " + String.format("%.12f", Float.valueOf(Utility.fastSin(0.0f) - ((float) StrictMath.sin(0.0d)))));
        GameEngine.log("diff sin(45): " + String.format("%.12f", Float.valueOf(Utility.fastSin(45.0f) - ((float) StrictMath.sin(0.7853981633974483d)))));
        GameEngine.log("diff sin(90): " + String.format("%.12f", Float.valueOf(Utility.fastSin(90.0f) - ((float) StrictMath.sin(1.5707963267948966d)))));
        GameEngine.log("diff sin(180):" + String.format("%.12f", Float.valueOf(Utility.fastSin(180.0f) - ((float) StrictMath.sin(3.141592653589793d)))));
