...
public class UnitStatsAction extends LogicAction {
    ...
    boolean teleportToActionTarget;
    ...
    public static void a(CustomUnitConfig customUnitConfig, IniFile iniFile, String str, String str2, CustomActionDef customActionDef, String str3, boolean z) throws ConfigParseException {
        ...
        boolean teleportToActionTarget = iniFile.getBoolean(
                str,
                str2 + "teleportToActionTarget",
                (Boolean) false
        ).booleanValue();
        if (teleportToActionTarget) {
            UnitStatsAction teleportAction = new UnitStatsAction();
            teleportAction.teleportToActionTarget = true;
            customActionDef.logicActions.add(teleportAction);
        }
    ...
    public boolean doAction(CustomUnit customUnit, AbstractUnitAction abstractUnitAction, PointF pointF, BaseUnit baseUnit, int i) {
        ...
        if (this.teleportToActionTarget && pointF != null) {
            customUnit.f(pointF.x, pointF.y);
        }
