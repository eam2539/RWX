...
public class AntiAirTurret extends TurretFactory {
    ...
    @Override
    // com.corrodinggames.rts.game.units.buildings.turrets.TurretFactory, com.corrodinggames.rts.game.units.buildings.FactoryWithQueue, com.corrodinggames.rts.game.units.OrderableUnit
    public float m() {
        if (!this.isUpgraded) {
            return 250.0f;
        }
    ...
    @Override
    // com.corrodinggames.rts.game.units.buildings.turrets.TurretFactory, com.corrodinggames.rts.game.units.OrderableUnit
    ...
    public void a(BaseUnit baseUnit, int i) {
        ...
        if (!this.isUpgraded) {
            ...
            projectileA.targetSpeed = 7.0f;
        }
        projectileA.textureFrame = (short) 4;
        projectileA.renderScale = 1.0f;
        projectileA.targetUnit = baseUnit;
        projectileA.isBallistic = false;
        projectileA.minHeight = 0.0f;
        projectileA.maxHeight = 0.0f;
    ...
    @Override
    // com.corrodinggames.rts.game.units.buildings.turrets.TurretFactory, com.corrodinggames.rts.game.units.BaseUnit
    ...
    @Override
    // com.corrodinggames.rts.game.units.buildings.turrets.TurretFactory, com.corrodinggames.rts.game.units.buildings.BaseBuilding, com.corrodinggames.rts.game.units.OrderableUnit
    ...
    @Override
    // com.corrodinggames.rts.game.units.buildings.turrets.TurretFactory, com.corrodinggames.rts.game.units.buildings.FactoryWithQueue, com.corrodinggames.rts.game.units.buildings.FactoryQueueInterface
