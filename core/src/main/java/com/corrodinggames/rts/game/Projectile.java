...
public class Projectile extends PositionedObject {
    ...
    public static Projectile a(BaseUnit baseUnit, float f2, float f3) {
        ...
        projectile.posX = f2;
        projectile.posY = f3;
        projectile.ar = KoolArgbColor.a(255, 100, 30, 30);
                ...
                if (!this.E) {
                    ...
                    if (z10) {
                        ...
                        if (this.D && projectileTemplate.explodeEffect == null) {
                            ...
                            Effect effectCreateLightEffect = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, KoolArgbColor.a(255, 255, 255, 255));
                            ...
                            gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                            Effect effectCreateLightEffect2 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, KoolArgbColor.a(255, 255, 255, 255));
                            ...
                            gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                            Effect effectCreateLightEffect3 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, KoolArgbColor.a(255, 255, 244, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_DATA_SERVICE));
                            ...
                            for (int i3 = 0; i3 < 1; i3++) {
                                gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                                Effect effectCreateLightEffect4 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, KoolArgbColor.a(255, 255, 244, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_DATA_SERVICE));
                            ...
                            gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                            Effect effectCreateLightEffect5 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, KoolArgbColor.a(255, 255, 255, 255));
                            ...
                            gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                            Effect effectCreateLightEffect6 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, KoolArgbColor.a(255, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_3D_MODE, 255, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_SATELLITE_CS));
                            ...
                            gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                            Effect effectCreateLightEffect7 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, KoolArgbColor.a(255, 255, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_ANTENNA_CABLE, 129));
                            ...
                            gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                            Effect effectCreateLightEffect8 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, KoolArgbColor.a(245, 255, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_AVR_INPUT, 110));
                            ...
                            for (int i4 = 0; i4 < 4; i4++) {
                                gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                                Effect effectCreateLightEffect9 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, KoolArgbColor.a(SlickToAndroidKeycodes.AndroidCodes.KEYCODE_PAIRING, 255, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_ANTENNA_CABLE, 129));
                            ...
                            for (int i5 = 0; i5 < 2; i5++) {
                                gameEngine.effectManager.setOverrideEffectQuality(EffectQuality.critical);
                                Effect effectCreateLightEffect10 = gameEngine.effectManager.createLightEffect(this.aV, this.aW, this.posZ, KoolArgbColor.a(SlickToAndroidKeycodes.AndroidCodes.KEYCODE_PROG_YELLOW, 255, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_ANTENNA_CABLE, 129));
