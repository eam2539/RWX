...
public class VariableScope {
    ...
    public static class MemoryNames {
        public FastArrayList<VariableName> names = new FastArrayList();
    }
    ...
    public static class VariableDataNull extends VariableData {
        @Override
        // com.corrodinggames.rts.game.units.custom.logicBooleans.VariableScope.VariableData, com.corrodinggames.rts.game.units.custom.logicBooleans.LogicBoolean
    ...
    public static class VariableDataNumberArray extends VariableDataArray {
        ...
        @Override
        // com.corrodinggames.rts.game.units.custom.logicBooleans.VariableScope.VariableDataArray, com.corrodinggames.rts.game.units.custom.logicBooleans.VariableScope.VariableData, com.corrodinggames.rts.game.units.custom.logicBooleans.LogicBoolean
        public LogicBoolean.ReturnType getReturnType() {
    ...
    public static class MemoryWriterFactory extends CachedWriter.WriterFactory {
        ...
        public static class MemoryWriterElementIndex extends MemoryWriterElement {
            ...
            @Override
            // com.corrodinggames.rts.game.units.custom.logicBooleans.VariableScope.MemoryWriterFactory.MemoryWriterElement, com.corrodinggames.rts.game.units.custom.logicBooleans.VariableScope.CachedWriter.WriterElement
            public void writeToUnit(OrderableUnit orderableUnit) {
                if (orderableUnit.unitVariables == null) {
                    orderableUnit.unitVariables = new VariableScope();
                }
            ...
            @Override
            // com.corrodinggames.rts.game.units.custom.logicBooleans.VariableScope.MemoryWriterFactory.MemoryWriterElement
            public void writeToMemory(VariableScope variableScope, OrderableUnit orderableUnit) {
    ...
    public static class CachedWriter {
        FastArrayList<WriterElement> writers = new FastArrayList();
