                ...
                if (this.isRunning) {
                    ...
                    try {
                        ...
                        if (i2 < 3 && gameEngine.networkEngine.resetSyncState() > 0) {
                            String str2 = "Warning: server socket got closed and needed to FastArrayList recreated, players were likely disconnected (but can rejoin).";
                        ...
                        e3.printStackTrace();
                        GameEngine.getInstance().alert("Warning server socket got closed and could not FastArrayList recreated");
                        stop();
                        return;
                    }
                } else {
