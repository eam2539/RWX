                ...
                try {
                    ...
                    if (i >= 72) {
                        ...
                        if (z7) {
                            ...
                            if (gameEngine.replayEngine.j() && !z3) {
                                gameEngine.networkEngine.receivedCustomMapStream = gameEngine.remoteMapStream;
                            }
                        }
                    }
                    boolean canReuseReceivedMap = gameEngine.replayEngine.j()
                            || (gameEngine.networkEngine.networkGameActive && !gameEngine.networkEngine.isServer);
                    if (canReuseReceivedMap && z3 && gameEngine.networkEngine.receivedCustomMapStream != null && !z7) {
