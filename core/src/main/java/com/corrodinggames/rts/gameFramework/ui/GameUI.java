...
public final class GameUI extends Serializable {
    ...
    public void initializeUIResources() {
        ...
        this.unitIconTexture.a(KoolTypeface.a(KoolTypeface.c, 0));
        ...
        this.buildingIconTexture.a(KoolTypeface.a(KoolTypeface.c, 1));
        ...
        this.effectIconTexture.b(KoolArgbColor.a(SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_RADIO_SERVICE, 63, 80));
