...
public class MusicManager {
    ...
    /**
     * Makes a settings-page volume change audible without waiting for the game update loop.
     * Threaded music backends are woken immediately; non-threaded backends observe the flag
     * on their next regular update.
     */
