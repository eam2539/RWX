...
public class HeavyTankUnit extends LandUnit {
    ...
    public void a(BaseUnit baseUnit, int i) {
        ...
        if (!baseUnit.i()) {
            ...
            projectileA.color = Color.a(SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_TERRESTRIAL_ANALOG, 150, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_DATA_SERVICE, 40);
        ...
        projectileA2.speed = 0.5f;
        projectileA2.targetSpeed = 5.0f;
