...
public class ExperimentalTank extends LandUnit {
    ...
    public void a(BaseUnit baseUnit, int i) {
        if (!R(i)) {
            ...
            projectileA.color = Color.a(255, 247, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_EISU, 129);
            projectileA.lifeTimer = 120.0f;
            projectileA.speed = 5.0f;
            projectileA.targetUnit = baseUnit;
            projectileA.splashDamage = 60.0f;
            projectileA.damage = 40.0f;
            projectileA.explosionRadius = 45.0f;
            projectileA.damageEnemiesOnly = true;
            projectileA.renderScale = 2.0f;
            projectileA.isSmallExplosion = true;
            projectileA.textureFrame = (short) 9;
        ...
        projectileA2.color = Color.a(255, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_DATA_SERVICE, SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_DATA_SERVICE, 50);
        projectileA2.damage = 60.0f;
        projectileA2.targetUnit = baseUnit;
        projectileA2.lifeTimer = 190.0f;
        projectileA2.speed = 3.0f;
        projectileA2.targetSpeed = 6.0f;
        ...
        projectileA2.autoRetarget = true;
