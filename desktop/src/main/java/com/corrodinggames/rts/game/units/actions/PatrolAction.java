...
/* JADX INFO: renamed from: com.corrodinggames.rts.game.units.a.i */
/* JADX INFO: loaded from: game-lib.jar:com/corrodinggames/rts/game/units/a/i.class */
public class PatrolAction extends AbstractUnitAction {
    public PatrolAction() {
        super("c_9");
    }
