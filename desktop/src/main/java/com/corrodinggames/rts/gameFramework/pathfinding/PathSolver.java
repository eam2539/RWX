...
public final class PathSolver implements Runnable {
    ...
    public LinkedList e() {
            ...
            if (n4 != 0) {
                ...
                for (n15 = (int)(n9 - 25); n15 <= n9 + 25; n15 = (short)(n15 + 1)) {
                    for (n2 = (int)(n10 - 25); n2 <= n10 + 25; n2 = (short)(n2 + 1)) {
                        if (n15 < 0 || n15 >= n8 || n2 < 0 || n2 >= s2 || n5 != sArray[n15 * s2 + n2] && sArray[n15 * s2 + n2] != 0) continue;
        ...
        boolean bl2 = true;
        block6: for (n5 = (int)(n12 - s6); n5 <= n12 + s6; n5 = (short)(n5 + 1)) {
        ...
        while (!bl2) {
            ...
            for (by = by4; by <= by5; by = (byte)((byte)(by + 1))) {
                ...
                if (pathPoint.tileX < 0 || pathPoint.tileX >= n8 || pathPoint.tileY < 0 || pathPoint.tileY >= s2 || (n20 = pathPoint.a(this)) == -1) continue;
                ...
                if (pathPoint.tileX != pathPoint3.tileX && pathPoint.tileY != pathPoint3.tileY) {
                    if (this.a(pathPoint.tileX, pathPoint3.tileY) == -1 || this.a(pathPoint3.tileX, pathPoint.tileY) == -1) continue;
                    n19 = n18 + (14 + n20) + 1;
                } else {
                    n19 = n18 + (10 + n20) + 1;
                }
