...
public class SlickGameHandler extends BasicGame {
    ...
    public void a() {
        ...
        if (z != this.v) {
            GameEngine.log("Grabbing mouse:" + z);
            this.v = z;
            if (!this.u) {
    ...
    public int a(int i) {
        ...
        GameEngine.log("Unknown mouse button:" + i);
        return 0;
    }
    ...
    public void a(int i, int i2, boolean z) {
        ...
        int i4;
        if (this.y) {
            GameEngine.log("mouseGrab:m:" + z + ",newX:" + i + ",newY:" + i2);
        }
        if (!this.v) {
            this.w = (int) (i / this.P);
    ...
    public void a(String str, boolean z) {
        ...
        if (!str.startsWith("Loading units ")) {
            GameEngine.log("--Now loading:" + str);
            z2 = false;
        }
        if (z) {
            this.N = this.M;
                        ...
                        public void run() {
                            try {
                                ...
                                try {
                                    ...
                                    GameEngine.log("Screenshot saved: " + str);
                                } catch (Throwable th) {
                                    fileOutputStream.close();
                                    throw th;
                                }
