...
public class SlickTexture extends Texture {
    ...
    public void J() {
        ...
        GameEngine.log("Recreating image data from texture: " + a() + " (" + PerformanceProfiler.a(PerformanceProfiler.a(jA)) + ")");
    }
    ...
    public void t() {
        ...
        if (this.J == -1) {
            ...
            GameEngine.log("reloadImage: '" + this.C + "' reloading current now:" + jC);
            F();
            this.J = jC;
        }
    }
    ...
    public void G() {
        GameEngine.log("SlickBitmapOrTexture: " + a());
        GameEngine.log(" className:" + getClass().getSimpleName());
