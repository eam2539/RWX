...
public class SteamWorkshopManager {
    ...
    private void e(SteamPublishedFileID steamPublishedFileID) {
        GameEngine.log("Adding request for workshop details: " + steamPublishedFileID);
    ...
    public WorkshopItemInfo a(SteamPublishedFileID steamPublishedFileID) {
        ...
        if (workshopItemInfo == null) {
            GameEngine.log("New ItemInfo: " + steamPublishedFileID);
    ...
    public String b(SteamPublishedFileID steamPublishedFileID) {
        ...
        if (workshopItemInfoA.c) {
            GameEngine.log("Got data for: " + steamPublishedFileID + " - " + workshopItemInfoA.d);
            return workshopItemInfoA.d;
        }
        GameEngine.log("No data for: " + steamPublishedFileID);
        return null;
    }
    ...
    public void a(ModInfo modInfo, boolean z, String str) {
        ...
        GameEngine.log("submitted item update for:" + modInfo.steamId);
    }
    ...
    public void c() throws IOException {
        ...
        if (numSubscribedItems != this.k) {
            GameEngine.log("Number of subscribed items changed from: " + this.k + " to: " + numSubscribedItems);
    ...
    public void d() throws IOException {
        ...
        for (SteamPublishedFileID steamPublishedFileID : steamPublishedFileIDArr) {
            ...
            GameEngine.log("Found workshop item " + jD + " with state: " + str + VariableScope.nullOrMissingString);
            String str2 = "sw" + jD;
            ...
            String str4 = null;
            if (!z5) {
                GameEngine.log("Skipping: " + jD + " as it is not subscribed");
            } else {
                if (z) {
                    ...
                    GameEngine.log(" Installed at: " + folder);
                } else {
                ...
                if ((!z || z4) && (!z2 || z3)) {
                    GameEngine.log("Queuing download on: " + steamPublishedFileID);
