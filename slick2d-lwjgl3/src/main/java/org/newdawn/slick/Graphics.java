...
public class Graphics {
    ...
    /**
     * Set the current color without cloning the input.
     *
     * This is for render paths that already reuse a mutable scratch color and
     * need to avoid the extra allocation performed by {@link #setColor(Color)}.
     */
    ...
    /**
     * Rebind the current color without allocating a copy.
     */
     ...
     * always in absolute screen space coordinates.
     *
     * @param rect The rectangle describing the clipped area in screen
     *             coordinates
     */
     ...
     *
     * @param x1     The x coordinate of the top left corner of a box containing
     *               the oval
     * @param y1     The y coordinate of the top left corner of a box containing
     *               the oval
     ...
     *
     * @param width The width of the line to be used when drawing line based
     *              primitives
     */
     ...
     * @param srcx  The x position of the rectangle to draw from this image (i.e.
     *              relative to the image)
     * @param srcy  The y position of the rectangle to draw from this image (i.e.
     *              relative to the image)
     * @param srcx2 The x position of the bottom right cornder of rectangle to
     *              draw from this image (i.e. relative to the image)
     * @param srcy2 The t position of the bottom right cornder of rectangle to
     *              draw from this image (i.e. relative to the image)
     */
