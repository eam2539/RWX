...
public class FontUtils {
     ...
     *
     * @param font      The font to draw with
     * @param s         The given non-null {@link String} to use to calculate the
     ...
     *                            {@link String}.
     * @param justifiedSpaceWidth The integer specifying the width of a justified space
     *                            {@link String}, in pixels.
     * @return The resulting x-coordinate of the current cursor after the
     * drawing operation completes.
     * @throws NullPointerException Throws a {@link NullPointerException} if any of the given
     *                              arguments are null.
     */
